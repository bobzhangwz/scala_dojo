...
lazy val projectSettings = Seq(
  name := "scala-dojo",
  version := "0.0.1",
  organization := "au.com.realestate",
  scalaVersion := "2.12.6",
  resolvers ++= Seq(
...
// The newrelic configuration is only used in Docker builds, so we give it it's own config, and put
// the newrelic libraries in that config.
